...
var text = [
    [
        "「教育部國民及學前教育署106學年度資優鑑定」有採認其部分獎項之競賽，或競賽具有高聲望，且進入決賽門檻極高者。",
        "「教育部國民及學前教育署106學年度資優鑑定」有採認其部分獎項之競賽，或競賽具有高聲望，且決賽門檻高且參賽人數眾多者。"
    ],[
        "有兩個階段以上競賽或審查；進入決賽者，獲獎率低於50%者。",
        "競賽具有一定程度聲望，參賽人數多。"
    ],[
        "參賽門檻低、獲獎率達50%以上者。",
        "參賽門檻低，為單次競賽或測驗者，且非選拔國際賽選手。"
    ]
];
...
function showModal(filename, ref){
    ...
    if(ref){
        $('#ref-text').css("visibility", "visible");        
        modal_header_ref.innerHTML = ref;
        switch(ref){
            case "A":
                modal_header_ref.style.color = "rgb(255, 0, 214)";
                $('#official-text').text(text[0][0]); 
                $('#non-official-text').text(text[0][1]);                                
                break;
            case "B":
                modal_header_ref.style.color = "rgb(101, 174, 242)";
                $('#official-text').text(text[1][0]);                
                $('#non-official-text').text(text[1][1]);                
                break;
            case "C":
                modal_header_ref.style.color = "rgb(108, 242, 105)";
                $('#official-text').text(text[2][0]);                
                $('#non-official-text').text(text[2][1]);                
                break;
        }
        ...
        $('#ref-text').css("visibility", "hidden");
    }
}
